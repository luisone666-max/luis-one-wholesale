...
export function OrderSuccessDetails() {
  ...
  if (!order) {
    return (
      <div className="rounded-md border border-orange-100 bg-white p-8 text-center shadow-sm">
        ...
        <Link href="/my-orders" className="mt-5 inline-flex rounded-md bg-[#f65f18] px-5 py-3 text-sm font-black text-white">
          View My Orders
        </Link>
      </div>
    );
  ...
  return (
    <div className="rounded-md border border-orange-100 bg-white p-8 text-center shadow-sm">
      ...
      <h1 className="mt-3 text-4xl font-black tracking-tight text-zinc-950">Order No: {order.orderNo}</h1>
