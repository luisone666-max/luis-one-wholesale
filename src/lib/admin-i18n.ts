...
export const adminDictionaries: Record<AdminLanguage, Partial<Record<TranslationKey, string>>> = {
  en: {
    ...
    cashierCenter: "Offline Cashier",
    categories: "Categories",
    category: "Category",
    categoryNameEn: "Category Name English",
    categoryNameZh: "Category Name Chinese",
    categoryName: "Category Name",
    categoryRules: "Disabled categories and their products are hidden from the customer frontend.",
    ...
    pickupNoShippingFee: "Store Pickup / No Shipping Fee",
    ...
    freightCollect: "Paid to Rider / Receiver",
    prepaidShipping: "Prepaid Shipping",
    toBeConfirmed: "To be Confirmed",
    localDelivery: "Lalamove",
    courierShipping: "J&T Express COD",
  ...
  zh: {
    ...
    cancelled: "已取消",
    cashDrawer: "收银钱箱",
    cashierCenter: "线下收银确认",
    categories: "分类",
    category: "分类",
    categoryNameEn: "分类英文名",
    categoryNameZh: "分类中文名",
    categoryName: "分类名称",
    categoryRules: "禁用分类及其商品会从客户前台隐藏。",
...
const zhCleanOverrides: Partial<Record<TranslationKey, string>> = {
  actions: "操作",
  activeProducts: "上架商品",
  activeStatus: "上架状态",
  activeToggle: "启用",
  ...
  categoryNameZh: "分类中文名",
  categoryName: "分类名称",
  categoryRules: "停用分类和分类下商品不会显示在客户前台。",
  categoryTreeHint: "最多 3 层：主分类 > 子分类 > 三级分类",
  childCategory: "三级分类",
  completed: "已完成",
  completedOrders: "已完成订单",
  createCategory: "创建分类",
  ...
  date: "日期",
  delete: "删除",
  deleteBlocked: "无法删除：分类必须没有商品、没有子分类。",
  deleteChildWarning: "这个分类还有子分类，请先移动或删除子分类。",
  deleteProductWarning: "这个分类还有商品，请先移动或隐藏商品。",
  description: "描述",
  depositPaid: "订金已付",
  depositPaidOrders: "订金已付订单",
  disable: "停用",
  disabledHidden: "停用分类会保留在后台，但客户前台不会显示。",
  edit: "编辑",
  enable: "启用",
  facebookMessenger: "Facebook / Messenger",
  facebookPageUrl: "Facebook 主页链接",
  filterCategory: "按分类筛选",
  filterStock: "按库存状态筛选",
  filterActive: "按上架/隐藏筛选",
  hideProductsFirst: "请先移动或隐藏商品。",
  iconImageUrl: "图标 / 图片链接",
  image: "图片",
  productImage: "商品图片",
  imageUrl: "图片链接",
  language: "语言",
  ...
  logout: "退出登录",
  mainCategory: "主分类",
  manualPayments: "人工收款记录",
  mergeCategory: "合并分类",
  mergeConfirmation: "该分类下的商品会移动到目标分类。",
  mergeInto: "合并到",
  ...
  internalCostNotes: "内部成本备注",
  adminNotes: "管理员备注",
  supplierNotesAdminOnly: "供应商备注仅后台可见，不会显示在客户前台。",
  supplierInternalFields: "供应商 / 内部字段",
  basicInfo: "基础信息",
  categoryTab: "分类",
  wholesalePricesTab: "批发价格",
  ...
  lowStock: "低库存",
  unavailable: "无货",
  noAutomaticPricing: "客户价格由批发阶梯手动设置，不自动按成本加价。",
  bulkUploadTitle: "批量上传",
  downloadCsvTemplate: "下载 CSV 模板",
  uploadCsvArea: "上传 CSV 区域",
  previewImport: "预览导入",
...
export function translate(language: AdminLanguage, key: TranslationKey) {
  if (language === "zh" && zhCleanOverrides[key]) {
    return zhCleanOverrides[key];
  }
